...
from db_functions import (connect_to_db, get_basic_info, get_additonal_tables, add_new_manual_id,
                          get_categories, get_suppliers, get_all_products,get_product_history, place_reorder,
...
# main space
st.title("Inventory and Supply Dashboard")
db = connect_to_db()
...
if option == "Basic Information":
    ...
    if selected_task == "Add New Product":
        ...
        with st.form("Add_Product_Form"):
            ...
            product_level = st.number_input("Record level", min_value=0, step=1)
